      ...
      <div className="bookInfor__container">
        ...
        <div className="bookInfor__content col l-12">
          <div className="bookInfor__content--infor l-12">
            <p className="bookInfor__content--tag l-3">Mã hàng</p>
            <p className="bookInfor__content--name  l-4">
              {" "}
              {dataBookDetail._id}
            </p>
          </div>
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Tên sản phẩm</p>
            <p className="bookInfor__content--name l-4">
              {dataBookDetail.mainText}
            </p>
          </div>
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Tác giả</p>
            <p className="bookInfor__content--name l-4 bookInfor__link">
              {dataBookDetail.author}
            </p>
          </div>
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">NXB</p>
            <p className="bookInfor__content--name l-4">Hà Nội</p>
          </div>

          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Trọng lượng (gr)</p>
            <p className="bookInfor__content--name l-4">
              {" "}
          ...
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Kích Thước Bao Bì</p>
            <p className="bookInfor__content--name l-4">24 x 15.5 x 2.7 cm</p>
          </div>
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Số trang</p>
            <p className="bookInfor__content--name l-4">
              {Math.floor(+dataBookDetail.price / 400)}
            </p>
          </div>
          <div className="bookInfor__content--infor">
            <p className="bookInfor__content--tag l-3">Hình thức</p>
            <p className="bookInfor__content--name l-4">Bìa mềm</p>
          </div>
